    ...
    <style>
        ...
        .hero-banner {
            background: linear-gradient(rgba(3, 37, 65, 0.8), rgba(3, 37, 65, 0.8)), 
                        url("<?php echo e(asset('storage/banner.jpg')); ?>");
            ...
            <div class="col-md-3 mb-4">
                <div class="sidebar-top10 shadow">
                    ...
                    <div class="list-group list-group-flush">
                        <?php $__empty_1 = true; $__currentLoopData = collect($movies)->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
                                <span class="fw-bold text-warning me-3" style="width: 20px;">
                                    <?php if($movie['rank'] == 1): ?>
                                        <i class="fa-solid fa-crown text-warning"></i>
                                    <?php else: ?>
                                        #<?php echo e($movie['rank']); ?>

                                    <?php endif; ?>
                                </span>
                                <div class="text-truncate">
                                    <div class="text-white fw-semibold text-truncate"><?php echo e($movie['title']); ?></div>
                                    <small style="font-size: 0.8rem; color: #888;">
                                        <i class="fa-solid fa-star text-warning"></i> <?php echo e($movie['avg_rating']); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col">
                            <div class="movie-card">
                                <!-- Ảnh Poster Phim -->
                                <img src="<?php echo e(asset('storage/' . $movie['tmdbId'] . '.jpg')); ?>" 
                                     class="movie-poster" 
                                     onerror="this.onerror=null; this.src='https://placehold.co/300x450/032541/ffffff?text=<?php echo e(urlencode($movie['title'])); ?>';"
                                ...
                                <div class="movie-info">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-2 px-1">
                                        <span class="text-muted" style="font-size: 0.85rem;">
                                            <i class="fa-solid fa-users me-1"></i> <?php echo e(number_format($movie['rating_count'])); ?> lượt
                                        </span>
                                    ...
                                    <div class="mt-3 pt-2 border-top text-center">
                                        <div class="ai-score-box">
                                            <i class="fa-solid fa-brain me-1 text-success"></i> AI Score: <span class="text-dark"><?php echo e($movie['score']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
</html><?php /**PATH D:\laravel\nhom_AIN\resources\views/popularity_movies.blade.php ENDPATH**/ ?>